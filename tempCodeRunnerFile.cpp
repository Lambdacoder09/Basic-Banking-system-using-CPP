...
int main() {
    ...
    cout << "3. Money Transfer between accounts" << endl;
    cout << "0. Exit" << endl;  // Added option to exit
    cout << "============================" << endl;
    cout << "Please enter your choice: ";
        ...
        switch (input) {
            case 1:
                ...
                cout << "account has been created with userid"<< user1.id << endl;
...
int generateAccountID() {
    static int counter = 1000; // Start from 1000
    return counter++;
}
